<template>
    <div class="card w-11/12 lg:card-side shadow-xl font-summerpixel"
        :class="findColor(role.id)[0]"
        ref="roleCard"
    >
        <div class="grid items-center gap-y-1 gap-x-1 p-1
            h-1/2 md:h-2/3 grid-flow-row grid-cols-2 auto-rows-fr
        ...
        <div class="card-body h-1/2 md:h-2/3 lg:h-full lg:w-1/5">
            <h2 class="card-title">{{ role.name }}</h2>

            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Cumque autem aut ratione iste. Est placeat, nemo veniam assumenda consequatur cum porro. Consequuntur consequatur impedit odio!</p>
