    ...
    <div class="drawer bg-base-200 font-ostrich">
        ...
        <div class="drawer-content flex flex-col">
            ...
            <nav class="w-full navbar bg-base-300">
                ...
                <img src="/images/light-mode-icon.svg" class="h-10 self-center"
                    :class="checked ? 'invert' : 'invert-0'" />

                <input type="checkbox" class="toggle toggle-lg self-center" data-toggle-theme="garden,luxury"
                    data-act-class="ACTIVECLASS" v-model="checked" />

                <img src="/images/dark-mode-icon.svg" class="h-10 self-center"
                    :class="checked ? 'invert' : 'invert-0'" />

                <!-- DESKTOP MENU -->
                <div class="flex-none hidden lg:block lg:ml-6">
        ...
        <div class="drawer-side">
            ...
            <ul class="menu p-4 overflow-y-auto w-80 bg-base-100 space-y-4">
                <button class="btn btn-error mb-6" @click="toggle = false">
                    CLOSE
                </button>

                <NavLink href="/" :active="$page.component === 'Home'" @click="toggle = false">Home</NavLink>

                <NavLink href="/settings" :active="$page.component === 'Settings'" @click="toggle = false">Settings
                </NavLink>
            </ul>
        </div>
    </div>
